...
//        echo "<hr>";
    ...
    function guardaregistroinicial($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/guardaregistroinicial';
    ...
    function recuperarRegistro($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/recuperarRegistro';
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/recuperarRegistro';
        }
        return $this->post($ruta, $data);
    ...
    function checklogin($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/checklogin';
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/checklogin';
        }
        return $this->post($ruta, $data);
    ...
    function guardadatosescuela($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/guardadatosescuela';
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/guardadatosescuela';
        }
        return $this->post($ruta, $data);
    ...
    function guardadatosparticulares($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/guardadatosparticulares';
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/guardadatosparticulares';
        }
        return $this->post($ruta, $data);
    ...
    function checarfoto($id, $img_path) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/checarfoto/' . $id . '/ProyectoInvidentes2015/Pr0y3ct01nv1d3nt35';
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/checarfoto/' . $id . '/ProyectoInvidentes2015/Pr0y3ct01nv1d3nt35';
        }
    ...
    function confirmafoto($id) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/confirmafoto/' . $id . '/ProyectoInvidentes2015/Pr0y3ct01nv1d3nt35';
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/confirmafoto/' . $id . '/ProyectoInvidentes2015/Pr0y3ct01nv1d3nt35';
        }
    ...
    function guardarPregunta($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/guarda';
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/guarda';
        }
        return $this->post($ruta, $data);
    ...
    function opcionesPregunta($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/opciones';
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/opciones';
        }
        return $this->post($ruta, $data);
    ...
    function respuestasAspirante($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/lista';
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/lista';
        }
        return $this->post($ruta, $data);
    ...
    function credencial($id, $numPago) {
        if ($this->modo === 0) {//modo producción
            $ruta = 'http://unDominio.com/index.php/tyflos/imprimirCredencial/' . $id . '/ProyectoInvidentes2015/Pr0y3ct01nv1d3nt35/' . $numPago;
        } else {//modo desarrollo
            $ruta = 'http://unDominio.com/index.php/tyflos/imprimirCredencial/' . $id . '/ProyectoInvidentes2015/Pr0y3ct01nv1d3nt35/' . $numPago;
        }
    ...
    function ordenPago($id, $numSol = 0) {
        if ($this->modo === 0) {//modo producción
            $ruta = "http://unDominio.com/index.php/tyflos/imprimir_pago/" . $numSol . "/" . $id;
        } else {//modo desarrollo
            $ruta = "http://unDominio.com/index.php/tyflos/imprimir_pago/" . $numSol . "/" . $id;
        }
        return $this->get($ruta);
    ...
    function folioUV($id, $numSol = 0) {
        if ($this->modo === 0) {//modo producción
            $ruta = "http://unDominio.com/index.php/tyflos/imprimir_folio/" . $numSol . "/" . $id;
        } else {//modo desarrollo
            $ruta = "http://unDominio.com/index.php/tyflos/imprimir_folio/" . $numSol . "/" . $id;
        }
        return $this->get($ruta);
    ...
    function getAsp() {
        if ($this->modo === 0) {//modo producción
            $ruta = "http://unDominio.com/index.php/tyflos/get_foliosdadosTyflos";
        } else {//modo desarrollo
            $ruta = "http://unDominio.com/index.php/tyflos/get_foliosdadosTyflos";
        }
        return $this->get($ruta);
    ...
    function guardaDatosFamiliares($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = "http://unDominio.com/index.php/tyflos/guardaDatosFamiliares";
        } else {//modo desarrollo
            $ruta = "http://unDominio.com/index.php/tyflos/guardaDatosFamiliares";
        }
        return $this->post($ruta, $data);
    ...
    function valRegistroExistente($data) {
        if ($this->modo === 0) {//modo producción
            $ruta = "http://unDominio.com/index.php/tyflos/contarRegistrosPorCurp";
        } else {//modo desarrollo
            $ruta = "http://unDominio.com/index.php/tyflos/contarRegistrosPorCurp";
        }
        return $this->post($ruta, $data);
