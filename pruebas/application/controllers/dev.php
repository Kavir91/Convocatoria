...
class dev extends CI_Controller {
    ...
    public function curp() {
        ...
        $data['asp_curp'] = 'MAPC920406HVZRRR07';
        $res = $this->webservice->valRegistroExistente($data);
	...
	public function asp_1(){
	echo json_encode ($this->nativesession->get('asp'));
	}
