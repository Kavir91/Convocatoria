...
//                    $this->load->library('webservice');
//                    $modo = $this->webservice->getModo();
//                    $res = $this->aspirante->add($user->id_usuario, $data->datosUsuario->folio, $modo);
//                } catch (Exception $ex) {
////                    if ($modo === 1) {
...
//                            //echo $formato;
//                            $res1 = $this->aspirante->update($user->id_usuario, "datosEscolares", 0, $formato);
//                            $res1 = $this->aspirante->update($user->id_usuario, "datosPersonales", 1);
//                        } catch (Exception $ex) {
//                            
//                        }
...
//                            $formato = $fecha->format("Y-m-d H:i:s");
//                            //echo $formato;
//                            $res1 = $this->aspirante->update($user->id_usuario, "datosPersonales", 0, $formato);
//                            $res1 = $this->aspirante->update($user->id_usuario, "datosFamiliares", 1);
//                        } catch (Exception $ex) {
//                            
//                        }
        ...
        if ($guardar == FALSE) {
            ...
            if ($this->input->post() != FALSE) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    $datasend['asp_mismodom'] = '';
                    $datasend['asp_dependede'] = '';
                    $datasend['asp_cuantoscontribuyen'] = '';

                    $datasend['nombre_1'] = '';
                    $datasend['appaterno_1'] = '';
                    $datasend['apmaterno_1'] = '';
                    $datasend['sexo_1'] = '';
                    $datasend['edad_1'] = '';
                    $datasend['parentesco_1'] = '';
                    $datasend['ultimogrado_1'] = '';
                    $datasend['asisteescuela_1'] = '';
                    $datasend['quehace_1'] = '';
                    $datasend['ocupacion_1'] = '';
                    $datasend['ingreso_1'] = '';

                    $datasend['periodopago_1'] = '';

                    $datasend['recibegob_1'] = '';
                    $datasend['recibejub_1'] = '';
                    $datasend['recibeotropais_1'] = '';
                    $datasend['recibeestepais_1'] = '';
                    $datasend['recibeotras_1'] = '';
                    $datasend['entrabajoes_1'] = '';


                    $this->webservice->guardaDatosFamiliares();
                    echo "true";
